...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=168)


# 绪论
## 1.1 研究背景
现在大家正处于互联网加的时代，这个时代它就是一个信息内容无比丰富，信息处理与管理变得越加高效的网络化的时代，这个时代让大家的生活不仅变得更加地便利化，也让时间变得更加地宝贵化，因为每天的每分钟，每秒钟这些时间都能让人们处理大批量的日常事务，这些场景，是之前的手工模式无法与之相抗衡的。对于教室信息的管理来说，传统的通过纸质文档记录信息的方式已经落后了，依靠手工管理这些信息，不仅花费较长的工作时间，在对记录各种信息的文档进行信息统计以及信息核对操作时，也不能及时保证信息的准确性，基于这样的办公低效率环境下，对于教室信息的处理就要提出新的解决方案。因为这个时代的信息一直都在高速发展，要是不抱着发展的观念看待事情，极有可能被这个市场快速遗忘，甚至被无情地淘汰掉。所以尽早开发一款教室信息管理系统进行信息的快速处理，既跟上了时代的发展脚步，也能让自己的核心竞争力有所提升。
## 1.2目的和意义
互联网加的时代一方面是加快信息的发展，另一方面也是对传统行业进行筛选，能够继续发展的，肯定是那些能够充分运用互联网技术进行自身升级改革的行业。那些停步不前的行业只能就此结束，进而被大家所遗忘。这次设计出来的教室信息管理系统，它不仅能够让管理人员在信息增加，信息的编辑等事务处理上，节省很多的时间，也会砍掉一部分的人工成本，节省不必要开支的资金。另外，此系统的操作界面是可视化的界面，管理人员无需付费培训就能尽快上手。教室信息管理系统的开发意义如下：
...
4、教室信息都是通过网站进行显示，其实质是这些信息都保存在网站对应的数据库里面。只要操作员不去恶意删除信息，那么这些信息将会永久保存。
## 1.3 论文结构安排
编写教室信息管理系统相对应的论文，其实就是对开发完成的程序进行再次解读的过程。本论文从七个方面的内容讲解了开发的程序，具体内容如下：
...
# 3 系统分析
## 3.1系统可行性分析
需要使用大部分精力开发的教室信息管理系统为了充分降低开发风险，特意在开发之前进行可行性分析这个验证系统开发是否可行的步骤。本文就会从技术角度，经济角度，还有用户使用的程序的运行角度进行综合阐述。
### 3.1.1 技术可行性分析
...
## 3.3系统流程分析
管理员假如要操作系统提供的功能，那么管理员就要在系统的登录界面，填写管理员登录的账号信息，填写相应的密码信息，管理员需要保证这两者能够验证身份的账号以及密码信息的正确性，这样管理员就可以通过登录界面进入系统后台操作界面。图3.1就是开发的程序软件教室信息管理系统它的操作流程图。

![](/md/blog.001.png)

图3.1 系统操作流程图
### 3.3.1系统登录流程
教室信息管理系统的登录流程，针对的角色就是操作员的操作角色。在登录界面需要的必填信息就是账号信息，配上登录的密码信息就能登录教室信息管理系统，需要注意的就是必填的账号信息和登录密码信息，都需要进行验证，系统会判断账号还有填写的密码信息的正确性，只有这两者信息都正确了，就能成功登录教室信息管理系统了。系统登录流程图如下图。
...
# 4 系统设计
## 4.1系统概要设计
教室信息管理系统并没有使用C/S结构，而是基于网络浏览器的方式去访问服务器，进而获取需要的数据信息，这种依靠浏览器进行数据访问的模式就是现在用得比较广泛的适用于广域网并且没有网速限制要求的B/S结构，图4.1就是开发出来的程序工作原理图。
...
下面就展示教室信息管理系统的实体E-R图。

（1）下图是教室预约实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教室预约.jpg](/md/blog.007.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教室预约.jpg")
教室预约实体属性图

（2）下图是用户实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\用户.jpg](/md/blog.008.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\用户.jpg")
用户实体属性图

（3）下图是教师实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教师.jpg](/md/blog.009.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教师.jpg")
教师实体属性图

（4）下图是公告信息实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\公告信息.jpg](/md/blog.010.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\公告信息.jpg")
公告信息实体属性图

（5）下图是字典表实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\字典表.jpg](/md/blog.011.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\字典表.jpg")
字典表实体属性图

（6）下图是教室信息实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教室信息.jpg](/md/blog.012.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\教室信息.jpg")
教室信息实体属性图

（7）下图是用户表实体和其具备的属性。

![D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\用户表.jpg](/md/blog.013.jpeg "D:\111sheji\教室信息管理系统\jiaoshixinxiguanli\\img\用户表.jpg")
用户表实体属性图
### 4.3.2 数据库表结构设计
本次程序开发选用的数据库管理工具是MySQL数据管理工具，使用它存放数据也需要创建程序对应的数据库文件，并命名刚创建的数据库文件，有了数据库也需要创建各种数据表来充实数据库，在数据表的创建中，不仅需要对数据表命名，也需要对数据表的字段进行设计，包括每个数据表里面需要设置的字段名称，字段对应的数据类型信息，字段的主键设置这个也是不可缺少的，因为每个数据表里面的主键就是标记着这个数据表跟其他数据表相区分的唯一标志。就相当于生活中的每个人都有姓名，但是上网搜索自己的名字，会发现全国上下有很多人的名字跟自己的名字一模一样，包括姓氏以及名字，区分每个人的唯一信息就是每个人的身份证号信息，主键在数据表里面也是起着这样的重要作用。下面就介绍本次开发的程序教室信息管理系统的数据表结构信息。
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiaoshi\_uuid\_number|String|教室编号|是|
|3|jiaoshi\_name|String|教室标题|是|
|4|jiaoshi\_types|Integer|教室类型|是|
|5|jiaoshi\_status\_types|Integer|教室状态|是|
|6|jiaoshi\_photo|String|教室图片|是|
|7|jiaoshi\_address|String|教室地址|是|
|8|jiaoshi\_rongnaliang|Integer|教室容纳量|是|
|9|jiaoshi\_content|String|教室详情|是|
...
|5|laoshi\_photo|String|头像|是|
|6|sex\_types|Integer|性别|是|
|7|laoshi\_phone|String|联系方式|是|
|8|laoshi\_email|String|邮箱|是|
|9|laoshi\_delete|Integer|假删|是|
...
|5|shujiyuyue\_text|String|预约信息|是|
|6|shujiyuyue\_yesno\_types|Integer|预约审核|是|
|7|shujiyuyue\_yesno\_text|String|审核原因|是|
|8|shujiyuyue\_time||预约时间|是|
...
# 5 系统实现
## 5.1 用户信息管理
管理员可以管理用户信息，可以添加，修改，删除用户信息。下图就是房间信息管理页面。

![](/md/blog.014.png)

图5.1 用户信息管理页面
## 5.2 教师信息管理
管理员可以对教师信息进行添加，删除，查询和修改，以及审核操作。下图就是教师信息管理页面。

![](/md/blog.015.png)

图5.2教师信息管理页面
## 5.3 教室信息管理
管理员可以对教室信息进行添加，修改，查询，删除操作。下图就是教室信息管理页面。

![](/md/blog.016.png)

图5.3 教室信息管理页面
## 5.4 教室预约审核
管理员可以对教室预约信息进行审核操作。下图就是教室预约审核页面。
